...
from src.gl_generic_mlp import failure_payload, run_encrypted_weight_generic_mlp
...
def flatten(meta: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "total_block_matmuls": meta.get("total_block_matmuls") or meta.get("block_matmul_count") or schedule.get("total_linear_block_matmuls"),
